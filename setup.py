...
setup(
    ...
    version='0.0.1',
    description='Cryptocurrency sentiment web application for sentiment tracking and trading',
    author='guusvheijningen',
    author_email='gvanheijningen@crunchanalytics.be',
    url='https://github.com/GuusStavo38/CryptoSent',
